...
- **Frontend**: http://16.16.24.81:3000
- **Order Service API**: http://16.16.24.81:8080/api-docs
- **User Service API**: http://16.16.24.81:8081/api-docs
- **Inventory Service API**: http://16.16.24.81:8082/api-docs
- **Payment Service API**: http://16.16.24.81:8083/api-docs
...
- **User Service**: http://16.16.24.81:8081/api-docs
- **Inventory Service**: http://16.16.24.81:8082/api-docs
- **Order Service**: http://16.16.24.81:8080/api-docs
- **Payment Service**: http://16.16.24.81:8083/api-docs
...
```bash
curl -X POST http://16.16.24.81:8081/api/users/register \
...
```bash
curl -X POST http://16.16.24.81:8082/api/inventory/products \
  -H "Content-Type: application/json" \
  -d '{
    "name": "Sample Product",
...
```bash
curl -X POST http://16.16.24.81:8080/api/orders \
  -H "Content-Type: application/json" \
  -d '{
