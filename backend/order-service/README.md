...
MONGODB_URI=mongodb://16.16.24.81:27017/order-service

# Service URLs
USER_SERVICE_URL=http://16.16.24.81:8081
INVENTORY_SERVICE_URL=http://16.16.24.81:8082
PAYMENT_SERVICE_URL=http://16.16.24.81:8083
```
...
- Swagger UI: http://16.16.24.81:8080/api-docs
